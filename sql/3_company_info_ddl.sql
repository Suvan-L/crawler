...
CREATE TABLE `crawler_credit_china_company_list` (
    ...
    `accurate_entity_name_query` varchar(50) NULL COMMENT '[选填] 公司名（搜索）',
    ...
    `entity_name` varchar(20) NULL COMMENT '[选填] 法定代表人',
    `entity_enttype` varchar(20) NULL COMMENT '[选填] 企业类型',
    `entity_esdate` varchar(30) NULL COMMENT '[选填] 注册日期',
    `entity_dom` varchar(20) NULL COMMENT '[选填] 企业地址',
